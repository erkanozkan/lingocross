...
namespace LingoCross.Infrastructure.Migrations
{
    ...
    [Migration("20260630205016_AddAiQuestionTopicFields")]
    partial class AddAiQuestionTopicFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.DeviceToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.GameResultItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_game_result_items");

                    b.HasIndex("ResultId", "Ordinal")
                        .HasDatabaseName("ix_game_result_items_result_id_ordinal");

                    b.ToTable("game_result_items", (string)null);
                });
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.QuestionTopic", b =>
                {
                    ...
                    b.HasIndex("LessonId")
                        .HasDatabaseName("ix_question_topics_lesson_id");
                    ...
                    b.HasIndex("TeacherId")
                        .HasDatabaseName("ix_question_topics_teacher_id");
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("LatestReceiptRef")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)")
                        .HasColumnName("latest_receipt_ref");
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.GameResultItem", b =>
                {
                    b.HasOne("LingoCross.Domain.Entities.GameResult", "Result")
                        .WithMany("Items")
                        .HasForeignKey("ResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_game_result_items_game_results_result_id");
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.QuestionTopic", b =>
                {
                    b.HasOne("LingoCross.Domain.Entities.Lesson", null)
                        .WithMany()
                        .HasForeignKey("LessonId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_question_topics_lessons_lesson_id");

                    b.HasOne("LingoCross.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("TeacherId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_question_topics_users_teacher_id");
                });
            ...
            modelBuilder.Entity("LingoCross.Domain.Entities.Subscription", b =>
                {
                    b.HasOne("LingoCross.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("LingoCross.Domain.Entities.Subscription", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
