...
- **Öğrenci sınıfa nasıl katılır?** Öğretmenin paylaştığı davet koduyla "Sınıfa Katıl" ekranından.
- **Kameradan kelime tarama (AI) çalışmıyor.** Kamera izni verildiğinden emin ol; özellik gerçek cihazda çalışır (simülatörde sınırlıdır) ve iyi aydınlatma ister.
...
- **How does a student join a class?** Using the invite code the teacher shares, on the "Join class" screen.
- **AI camera word scanning isn't working.** Make sure camera permission is granted; the feature works on a real device (limited on simulator) and needs good lighting.
