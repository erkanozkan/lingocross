...
class _$RegisterRequestImpl implements _RegisterRequest {
  ...
  @override
  String toString() {
    return 'RegisterRequest(email: $email, password: $password, displayName: $displayName, role: $role)';
  }
...
class _$UserDtoImpl implements _UserDto {
  ...
  @override
  String toString() {
    return 'UserDto(id: $id, email: $email, displayName: $displayName, role: $role, preferredLocale: $preferredLocale, inviteCode: $inviteCode)';
  }
...
abstract class _UserDto implements UserDto {
  const factory _UserDto({
    ...
    required final String displayName,
    @UserRoleConverter() required final UserRole role,
    required final String preferredLocale,
    final String? inviteCode,
  }) = _$UserDtoImpl;
...
class _$AuthResponseImpl implements _AuthResponse {
  ...
  @override
  String toString() {
    return 'AuthResponse(accessToken: $accessToken, accessTokenExpiresAt: $accessTokenExpiresAt, refreshToken: $refreshToken, refreshTokenExpiresAt: $refreshTokenExpiresAt, user: $user)';
  }
